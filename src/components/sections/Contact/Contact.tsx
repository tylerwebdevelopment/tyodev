...
const Contact = () => {
  ...
  return (
    <section className="w-full mx-auto py-16 max-w-7xl px-4 space-y-12 sm:space-y-12 md:flex md:flex-row md:justify-evenly xl:justify-around xl:gap-32 md:gap-8">
      <div className="space-y-4 lg:space-y-6 lg:max-w-1/2 translate-y-1/12">
        <h1 className="tracking-widest text-center font-heading text-foreground/75">
          Get In Touch
        </h1>
        <p className="text-lg! hidden md:block text-center text-muted-foreground max-w-3xs mx-auto lg:max-w-md lg:text-xl!">Have a project in mind or just want to connect? I&apos;d love to hear from you.</p>
        <div className="hidden md:block">
          <p className="inline-flex gap-1.5 items-center w-full mt-8 lg:text-lg! justify-center text-foreground/75"><Mail className="size-4" /> Email: <Link className="hover:underline-offset-2 hover:underline" href='mailto:owner@tyodev.com'>Owner@tyodev.com</Link></p>
        </div>
        <div className="border-l-8 hidden md:block lg:mx-auto lg:w-fit text-center border-info pl-4 mt-16! py-2 bg-background">
          <p className="text-base! max-w-2xs lg:max-w-md lg:text-lg! text-muted-foreground">I&apos;m currently available for freelance work and open to new opportunities.</p>
          <p className="text-base! max-w-2xs lg:max-w-md lg:text-lg! text-muted-foreground mt-8!">I typically respond to all email inquries within 24-48 hours.</p>
        </div>
      </div>
        ...
        <Card className="max-w-md mx-auto">
          <CardHeader className="space-y-4 border-b border-border pb-4">
            ...
            <CardDescription className="text-center sm:w-3/4 sm:mx-auto">
              Tell me about your project and I&apos;ll get back to you within 24-48
              hours.
            </CardDescription>
          </CardHeader>
          <CardContent>
          ...
          <CardFooter className="border-t border-border py-4">
            <Field orientation="horizontal">
              <ContactSendButton
                ...
                disabled={form.formState.isSubmitting || submitStatus !== 'idle'}
              >
                ...
                ) : submitStatus === 'success' ? 'Sent' : submitStatus === 'error' ? 'Not Sent' : submitStatus === 'idle' && 'Send'}
              </ContactSendButton>
            </Field>
          </CardFooter>
        </Card>
